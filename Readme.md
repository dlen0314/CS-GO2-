...
> **[🖼️ 이미지 삽입 위치 1]** > **(여기에 `eda_result.png` 파일을 삽입하세요)** > *설명: 왼쪽은 1:1로 균형을 맞춘 라벨 분포 그래프이며, 오른쪽은 리뷰 문장 길이(단어 수) 분포이다. 대부분의 게이머들이 10~50 단어 내외로 짧게 리뷰를 남기는 것을 확인하여, 교수님이 지정해주신 MobileBERT의 `max_length`를 128로 설정해 학습 효율을 높일 수 있는 근거를 마련했다.*
